...
const GLOSARIO = [
  ...
  ['Grado jerarquico', 'Escala de la remuneracion dentro del regimen (columna hierarchical_grade). Sus valores estan sucios: conviven "10 B" y "10B", "8 -" y "8-", y ademas cambia de vocabulario a mitad de la serie.'],
