-- =====================================================================
-- ADIA 0007 - el detector aditivo solo enumeraba subconjuntos de 2 y 3
--             sumandos (y el conjunto completo), asi que la regla real de
--             4 terminos del archivo de nomina nunca llegaba a probarse y
--             ganaba una de 3 terminos con peor cobertura.
-- =====================================================================
