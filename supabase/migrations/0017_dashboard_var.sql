-- =====================================================================
-- ADIA 0017 - se seleccionaba una columna de texto (column_name) dentro de
-- v_r, que esta declarada jsonb: Postgres intentaba parsear
-- "institutional_position" como JSON y fallaba con 22P02. Se usa una
-- variable de texto aparte para la columna de categoria principal.
-- =====================================================================
